...
function FichaPersonagem() {
  ...
  // Poderes ofensivos (têm ataque + CD de dano)
    ...
    <div style={{ backgroundColor: 'black', minHeight: '100vh' }}>
      ...
      <div className="container">
          ...
          <div className="ficha-secoes">
            ...
            <div className="secao">
              ...
              <div className="secao-conteudo ofensivo-conteudo">
                ...
                {/* Iniciativa — rolável com ícone d20 */}
                <div
                  className="ofensivo-iniciativa"
                  ...
                  : poderesOfensivos.map(p => {
                      ...
                      return (
                        <div key={p.id} className="ofensivo-poder-bloco">
                          ...
                          {/* Rolagem de ataque — o atacante rola isso */}
                          <div
                            className="ofensivo-poder-linha"
                          ...
                          {/* CD do dano — informação para o alvo, não é rolagem do atacante */}
            ...
            <div className="secao">
              ...
              <div className="secao-conteudo">
                ...
                {/* Defesas passivas — o atacante precisa superar, sem rolagem do jogador */}
                ...
                {/* Testes defensivos — o jogador rola 1d20 + bônus */}
        ...
        <div className="coluna" id="coluna2">
          ...
          {/* MACHUCADOS */}
          <div className="secao machucados-secao">
            ...
            <div className="machucados-conteudo">
              ...
              {jogsPodemAlterar ? (
                ...
                <p style={{
                  ...
                  fontSize: '0.78rem', fontFamily: 'Crimson Pro, serif',
                  margin: '4px 0', fontStyle: 'italic'
                }}>
